...
namespace Pixicity.Data.Migrations
{
    ...
    [Migration("20220421001053_edit-table__monitor__usuarioQueHaceAccion__isNull")]
    partial class edittable__monitor__usuarioQueHaceAccion__isNull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Posts.Post", b =>
                {
                    ...
                    b.Property<bool>("SinComentarios")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Posts.SeguirPost", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Seguridad.Actividad", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ObjId1")
                        .HasColumnType("bigint");

                    b.Property<long>("ObjId2")
                        .HasColumnType("bigint");

                    b.Property<string>("TipoActividadString")
                        .HasColumnType("text")
                    ...
                    b.ToTable("Actividades", "Seguridad");
                });
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Seguridad.Usuario", b =>
                {
                    ...
                    b.Property<string>("RazonBaneo")
                        .HasColumnType("text");

                    b.Property<DateTime?>("TiempoBaneado")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Web.Configuracion", b =>
                {
                    ...
                    b.Property<bool>("DisableUserRegistration")
                        .HasColumnType("boolean");

                    b.Property<string>("DisableUserRegistrationMessage")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime>("RecordOnlineTime")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("RecordOnlineUsers")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Web.Contacto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pixicity.Data.Models.Web.Historial", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Historial", "Web");
                });

            modelBuilder.Entity("Pixicity.Data.Models.Web.Visitas", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("TipoVisitasString")
                        .HasColumnType("text")
                        .HasColumnName("Tipo");
